...
class AppColor {
  ...
  static Color grey = const Color.fromARGB(255, 70, 70, 70);
  static Color error = const Color.fromARGB(255, 218, 52, 52);
  static Color warning = const Color.fromARGB(255, 218, 190, 52);
  ...
  static Color whiteT = const Color.fromARGB(115, 213, 213, 213);
}
